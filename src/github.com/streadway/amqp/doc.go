...
/*
Package queue is an AMQP 0.9.1 client with RabbitMQ extensions
...
prior to calling Channel.Publish or Channel.Consume.
  ...
  // Connections start with queue.Dial() typically from a command line argument
  // or environment variable.
  connection, err := queue.Dial(os.Getenv("AMQP_URL"))
